...
function GroupedOptions(_ref) {
  ...
  return React__default.createElement("div", null, React__default.createElement("div", {
    ...
    return React__default.createElement(react.Combobox.Option, {
      key: option.id,
...
function AutoComplete(_ref) {
  ...
  return React__default.createElement(react.Combobox, {
    ...
    }, React__default.createElement(react.Combobox.Button, {
      tabIndex: 1,
    ...
    }, React__default.createElement(react.Combobox.Label, {
      tabIndex: 1,
    ...
    }), React__default.createElement(react.Combobox.Input, {
    ...
    })), React__default.createElement(react.Combobox.Options, {
...
function DatePicker(_ref) {
  ...
  var pickerInput = React.useRef(null);
  React.useEffect(function () {
    if (onDateChange) {
      onDateChange(date);
    }
...
function GroupedOptions$1(_ref) {
  ...
  return React__default.createElement("div", null, React__default.createElement("div", {
    ...
    return React__default.createElement(react.Listbox.Option, {
      key: option.id,
      className: function className(_ref2) {
        var active = _ref2.active;
        return classNames('cursor-pointer select-none relative py-2 px-4', active ? 'bg-gray-hover text-main-default' : '', selectedOption && selectedOption.id === option.id ? 'bg-primary-default text-white' : 'text-main-default');
...
function Dropdown(_ref) {
  ...
  return React__default.createElement(react.Listbox, {
    value: selectedOption,
    onChange: handleOnChange
  }, function (_ref2) {
    var open = _ref2.open;
    return React__default.createElement("div", {
      className: "relative block"
    }, React__default.createElement(react.Listbox.Button, {
    ...
    }, React__default.createElement(react.Listbox.Label, {
      ...
      className: classNames('absolute w-full text-base bg-white rounded-md shadow-md focus:outline-none border border-gray-spacer overflow-hidden', openTop ? 'bottom-11' : 'mt-1')
    }, React__default.createElement(react.Listbox.Options, {
...
function Loader(_ref) {
  ...
  }, React__default.createElement(reactLoaderSpinner.Rings, {
...
exports.Tag = Segment$1;
exports.TextAreaInput = TextAreaInput;
exports.TextInput = TextInput;
exports.WidgetError = WidgetError;
exports.classNames = classNames;
//# sourceMappingURL=textkit-ui-library.cjs.development.js.map
